...
Can you fix the code to get the correct result? The new source code is named CBL0106 and the JCL is called CBL0106J. You can find them in the github repository for the COBOL course.