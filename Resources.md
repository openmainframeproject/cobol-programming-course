...
Download data file from Labs folder from: [here](https://github.com/openmainframeproject/cobol-programming-course/tree/master/Labs/data) then go to the command line and execute zowe zos-files upload file-to-data-set "data" "Z8XXXX.DATA" -b
...
[Awesome Mainframes - Useful Links for z/OS and the Hercules Emulator](https://github.com/FuzzyMainframes/Awesome-Mainframes/blob/master/README.md)
